...
import ru.kedroff.project.managers.taskManager.FileBackedTasksManager;
...
class TaskManagerTest {
    ...
    void testGetAllTasks() {
        ...
        Assertions.assertEquals(taskList, Managers.getDefault().getAllTasks(), "Пустые листы задач не совпадают");
    ...
    void testGetTaskByID() {
        ...
        Assertions.assertEquals(task, Managers.getDefault().getTaskByID(task.getID()), "Нужная задача не возвращена");
        Assertions.assertNull(Managers.getDefault().getTaskByID(task.getID() + 123), "Возврат не null при попытке " +
                "вызова задачи с неправильным id");
        Managers.getDefault().deleteAllTasks();
        Assertions.assertNull(Managers.getDefault().getTaskByID(1), "Возврат не null при попытке вызова задачи с " +
    ...
    void testAddNewTask() {
        Task task = new Task("Read book every day", "30 pages");
        Managers.getDefault().addNewTask(task);
        Assertions.assertEquals(task.getID(), Managers.getDefault().getTaskByID(task.getID()).getID(), "В мапу добавлена " +
    ...
    void testDeleteTaskByID() {
        ...
        Assertions.assertNull(Managers.getDefault().getTaskByID(task1.getID()), "Задача не была удалена");
        Assertions.assertEquals(task2, Managers.getDefault().getTaskByID(task2.getID()), "Удалена другая задача");
        Managers.getDefault().deleteAllTasks();
    }
    ...
    void testGetSubtasksByID() {
        ...
        Subtask subtask11 = new Subtask("купить билеты", "дешёвые билеты", epic1.getID());
        Managers.getDefault().addNewSubtask(subtask11);
        Assertions.assertEquals(subtask11, Managers.getDefault().getSubtasksByID(subtask11.getID()), "Нужная подзадача " +
                "не возвращена");
        Assertions.assertNull(Managers.getDefault().getSubtasksByID(subtask11.getID() + 123), "Возврат не null " +
                "при попытке вызова задачи с неправильным id");
        Managers.getDefault().deleteAllEpics();
        Managers.getDefault().deleteAllSubtasks();
        Assertions.assertNull(Managers.getDefault().getSubtasksByID(1), "Возврат не null при попытке вызова " +
    ...
    void testAddNewSubtask() {
        ...
        Subtask subtask11 = new Subtask("купить билеты", "дешёвые билеты", epic1.getID());
        Managers.getDefault().addNewSubtask(subtask11);
        Assertions.assertEquals(subtask11.getID(), Managers.getDefault().getSubtasksByID(subtask11.getID()).getID(),
    ...
    void testDeleteSubtaskByID() {
        ...
        Assertions.assertNull(Managers.getDefault().getSubtasksByID(subtask11.getID()), "Подзадача не была удалена");
        Assertions.assertEquals(subtask12, Managers.getDefault().getSubtasksByID(subtask12.getID()), "Удалена " +
                "другая задача");
        Managers.getDefault().deleteAllEpics();
        Managers.getDefault().deleteAllSubtasks();
    }
    ...
    void testGetEpicByID() {
        Epic epic1 = new Epic("Съездить в Москву", "обязательно до лета");
        Managers.getDefault().addNewEpic(epic1);
        Assertions.assertEquals(epic1, Managers.getDefault().getEpicByID(epic1.getID()), "Нужный эпик не возвращен");
        Assertions.assertNull(Managers.getDefault().getEpicByID(epic1.getID() + 123), "Возврат не null при попытке " +
                "вызова эпика с нерпавильным id");
        Managers.getDefault().deleteAllEpics();
        Assertions.assertNull(Managers.getDefault().getEpicByID(1), "Возврат не null при попытке вызова эпика с " +
    ...
    void testAddNewEpic() {
        Epic epic1 = new Epic("Съездить в Москву", "обязательно до лета");
        Managers.getDefault().addNewEpic(epic1);
        Assertions.assertEquals(epic1.getID(), Managers.getDefault().getEpicByID(epic1.getID()).getID(), "В мапу " +
    ...
    void testDeleteEpicByID() {
        ...
        Assertions.assertNull(Managers.getDefault().getEpicByID(epic1.getID()), "Эпик не был удалён");
        Assertions.assertEquals(epic2, Managers.getDefault().getEpicByID(epic2.getID()), "Удалён другой эпик");
        Managers.getDefault().deleteAllEpics();
    }
    ...
    void tryToAddSubtasksWithNonexistentEpic() {
        ...
        Assertions.assertNull(Managers.getDefault().addNewSubtask(subtask11), "Ошибка при добавлении подзадачи " +
